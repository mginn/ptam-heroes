...
protected:
  ...
  //mnl>>custom function
  void ConvertDatatoDeviceType(std::vector<TrackerData*> &vTD, int nRange, int nSubPixIts) ;
  void CallKernelTrailTracking_Advance(std::vector<TrackerData*> &vTD, int nRange, int nSubPixIts) ;
  int SearchForPointsCustom(std::vector<TrackerData*> &vTD, int nRange, int nSubPixIts);
  //
