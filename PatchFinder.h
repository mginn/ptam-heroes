...
public:
  ...
  bool FindPatchCoarse(CVD::ImageRef ir, KeyFrame &kf, unsigned int nRange, int iter);
  ...
  //function added by Mainul to get the mnPatchsize
  inline int GetPatchSize() { return mnPatchSize; }
  //function added by Mainul to get the mnTemplate
  CVD::Image<CVD::byte> GetmimTemplate(){return mimTemplate;}

  //function added by Mainul to get the mnTemplateSumSq
  inline int GetTemplateSumQ(){return mnTemplateSumSq;}
  //function added by Mainul to get the mnTemplateSum
  inline int GetTemplateSum(){return mnTemplateSum;}
  //function added by Mainul to get the mnTemplateSum
  inline CVD::ImageRef GetmirCenter(){return mirCenter;}
  inline CVD::ImageRef GetPredicatedPos(){return mirPredictedPos;}
  inline bool GetmbFound(){return mbFound;}
  inline Vector<2>  Getmv2CoarsePos(){return mv2CoarsePos;}
  void  SetmbFound(bool x)
  {
	  mbFound=x;
  }

  void  SetTemplateSumQ(int SetmnTemplateSumSq)
  {
	  mnTemplateSumSq=SetmnTemplateSumSq;
  }

  void  SetTemplateSum(int SetmnTemplateSum)
  {
	  mnTemplateSumSq=SetmnTemplateSum;
  }

  void  SetmirCenter(int mirCenter_x,int mirCenter_y)
   {
	  mirCenter.x=mirCenter_x;
	  mirCenter.y=mirCenter_y;
   }

  void  SetPredicatedPos(int mirPredictedPos_x,int mirPredictedPos_y)
    {
	  mirPredictedPos.x=mirPredictedPos_x;
	  mirPredictedPos.y=mirPredictedPos_y;
    }

  void  Setmv2CoarsePos(float mv2CoarsePos_x,float mv2CoarsePos_y)
     {
	  mv2CoarsePos[0]=mv2CoarsePos_x;
	  mv2CoarsePos[1]=mv2CoarsePos_y;
     }
